...
function validate_component$1(component, name) {
    if (!component || !component.$$render) {
        if (name === 'svelte:component')
            name += ' this={...}';
        throw new Error(`<${name}> is not a valid SSR component. You may need to review your build config to ensure that dependencies are compiled, rather than imported as pre-compiled modules`);
...
let on_destroy$1;
function create_ssr_component$1(fn) {
    function $$render(result, props, bindings, slots) {
        const parent_component = current_component$1;
        const $$ = {
            on_destroy: on_destroy$1,
            context: new Map(parent_component ? parent_component.$$.context : []),
            // these will be immediately discarded
            on_mount: [],
            before_update: [],
...
/* C:\Users\loren\personal-projects\svelte-routing\src\Router.svelte generated by Svelte v3.28.0 */

const Router = create_ssr_component$1(($$result, $$props, $$bindings, slots) => {
	let $base;
	let $location;
	let $routes;
	let { basepath = "/" } = $$props;
...
/* C:\Users\loren\personal-projects\svelte-routing\src\Route.svelte generated by Svelte v3.28.0 */

const Route = create_ssr_component$1(($$result, $$props, $$bindings, slots) => {
	let $activeRoute;
	let $location;
	let { path = "" } = $$props;
	let { component = null } = $$props;
	let { canActivate = null } = $$props;
	let { canDeactivate = null } = $$props;
	...
	if ($$props.canActivate === void 0 && $$bindings.canActivate && canActivate !== void 0) $$bindings.canActivate(canActivate);
	if ($$props.canDeactivate === void 0 && $$bindings.canDeactivate && canDeactivate !== void 0) $$bindings.canDeactivate(canDeactivate);
	$activeRoute = get_store_value(activeRoute);
	$location = get_store_value(location);
	...
	? `${component !== null && shouldActivate
		? `${validate_component$1(component || missing_component, "svelte:component").$$render($$result, Object.assign({ location: $location }, routeParams, routeProps), {}, {})}`
		: `${slots.default
			? slots.default({
					params: routeParams,
					location: $location,
...
/* C:\Users\loren\personal-projects\svelte-routing\src\Link.svelte generated by Svelte v3.28.0 */

const Link = create_ssr_component$1(($$result, $$props, $$bindings, slots) => {
	let $base;
	let $location;
	let $activeRoute;
	let $routes;
...
/* src\components\NavLink.svelte generated by Svelte v3.28.0 */
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div>${validate_component(Route, "Route").$$render(
			$$result,
			{
				path: "about",
				component: About,
